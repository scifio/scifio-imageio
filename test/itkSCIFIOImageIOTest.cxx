...
int
RunTest(const char * inputFileName,
...
int
ProcessDimension(std::string  dim,
                 char *       argv[],
                 ...
                 bool         allSeries)
{
  if (dim == "2")
  {
    return RunTest<PixelType, 2>(
      inputFileName, outputFileName, seriesStart, seriesEnd, numberOfStreamDivisions, writeSCIFIO, allSeries);
  }
  else if (dim == "3")
  {
    return RunTest<PixelType, 3>(
      inputFileName, outputFileName, seriesStart, seriesEnd, numberOfStreamDivisions, writeSCIFIO, allSeries);
  }
  else if (dim == "4")
  {
    return RunTest<PixelType, 4>(
      inputFileName, outputFileName, seriesStart, seriesEnd, numberOfStreamDivisions, writeSCIFIO, allSeries);
  }
  else if (dim == "5")
  {
    return RunTest<PixelType, 5>(
      inputFileName, outputFileName, seriesStart, seriesEnd, numberOfStreamDivisions, writeSCIFIO, allSeries);
  }
  else
  {
           ...
           bool         allSeries)
{
  if (rgb)
  {
    return ProcessDimension<itk::RGBPixel<PixelType>>(dim,
                                                      argv,
                                                      inputFileName,
                                                      outputFileName,
                                                      seriesStart,
  ...
  return ProcessDimension<PixelType>(
    dim, argv, inputFileName, outputFileName, seriesStart, seriesEnd, numberOfStreamDivisions, writeSCIFIO, allSeries);
}
 ...
 */
int
itkSCIFIOImageIOTest(int argc, char * argv[])
{
  if (argc < 3)
  {
    return fail(argv);
  ...
  {
    return ProcessRGB<unsigned int>(rgb,
                                    dim,
                                    argv,
                                    inputFileName,
                                    outputFileName,
  ...
  {
    return ProcessRGB<unsigned char>(rgb,
                                     dim,
                                     argv,
                                     inputFileName,
                                     outputFileName,
  ...
  {
    return ProcessRGB<unsigned short>(rgb,
                                      dim,
                                      argv,
                                      inputFileName,
                                      outputFileName,
